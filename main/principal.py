...
def extrair_resultados(nome,politica,problema):
    ...
    return extrair_politica_parcial (nome + "politica_parcial", politica, problema)
...
for p in problemas_nomes:
    ...
    print ("tamanho do plano {}\n".format(extrair_resultados (p + "_iteracao_de_valor_", iteracao, deterministic_instances[p])))
